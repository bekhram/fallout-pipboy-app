...
export default function SheetEffects({form,derived,survivalConditions,onOpenConditions,onStealthBoyAdvance,onStealthBoyEnd}) {
  ...
  const feverCopy={
    en:{name:"Famished Fever",desc:"PER, CHA and INT tests are +1 difficulty. Progression depends on Duration.",duration:"Until cured"},
    ru:{name:"Голодная лихорадка",desc:"Проверки PER, CHA и INT имеют +1 к сложности. Эффекты усиливаются с Duration.",duration:"До излечения"},
    uk:{name:"Голодна лихоманка",desc:"Перевірки PER, CHA та INT мають +1 до складності. Ефекти посилюються з Duration.",duration:"До одужання"},
    pl:{name:"Gorączka Głodu",desc:"Testy PER, CHA i INT mają +1 do trudności. Efekty rosną wraz z Duration.",duration:"Do wyleczenia"},
  }[language]||null;
