...
const COPY={
  en:{title:"ECONOMY",treasury:"Treasury",daily:"Daily caps",turnover:"Today's trade turnover",net:"Trade net",stock:"Estimated stock value",upgrades:"UPGRADE ECONOMICS",payback:"Payback",days:"days",resource:"resource upgrade",noTrades:"No trades today"},
  ru:{title:"ЭКОНОМИКА",treasury:"Казна",daily:"Крышек за день",turnover:"Торговый оборот сегодня",net:"Чистый итог торговли",stock:"Оценка запасов",upgrades:"ЭКОНОМИКА УЛУЧШЕНИЙ",payback:"Окупаемость",days:"дней",resource:"ресурсное улучшение",noTrades:"Сегодня сделок нет"},
  uk:{title:"ЕКОНОМІКА",treasury:"Казна",daily:"Кришок за день",turnover:"Торговий оборот сьогодні",net:"Чистий підсумок торгівлі",stock:"Оцінка запасів",upgrades:"ЕКОНОМІКА ПОКРАЩЕНЬ",payback:"Окупність",days:"днів",resource:"ресурсне покращення",noTrades:"Сьогодні угод немає"},
  pl:{title:"EKONOMIA",treasury:"Skarbiec",daily:"Kapsle dziennie",turnover:"Dzisiejszy obrót",net:"Bilans handlu",stock:"Szacowana wartość zapasów",upgrades:"EKONOMIA ULEPSZEŃ",payback:"Zwrot",days:"dni",resource:"ulepszenie zasobów",noTrades:"Brak transakcji dzisiaj"},
};
