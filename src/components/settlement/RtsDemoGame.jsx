...
const WORKERS = [
  { id:'mara', name:'Mara', position:{x:8,y:12} },
  { id:'boone', name:'Boone', position:{x:15,y:12} },
  { id:'ada', name:'Ada', position:{x:11,y:15} },
  { id:'cooper', name:'Cooper', position:{x:12,y:8} },
];

const COPY = {
  en:{title:'RTS COMBAT DEMO',back:'BACK',selectAll:'SELECT ALL',clear:'CLEAR',move:'MOVE',hold:'HOLD',patrol:'PATROL',wave:'START WAVE',next:'NEXT WAVE',pause:'PAUSE',resume:'RESUME',reset:'RESET',selected:'Selected',defenders:'Defenders',enemies:'Enemies',hq:'HQ',ready:'Select defenders, place them, then start the wave.',active:'Raiders are attacking the settlement.',victory:'Wave repelled. Reposition your squad or start the next wave.',defeat:'HQ lost. Reset the demo and try another defense.',defenders_down:'No active defenders. Raiders are pushing toward HQ.',moveHint:'Tap a free cell to move the selected squad.',patrolHint:'Tap a cell to create a patrol route.',auto:'Defenders fire automatically when enemies enter range.',retreated:'retreated',down:'down'},
  ru:{title:'RTS БОЕВОЕ ДЕМО',back:'НАЗАД',selectAll:'ВЫБРАТЬ ВСЕХ',clear:'СНЯТЬ',move:'ИДТИ',hold:'ДЕРЖАТЬ',patrol:'ПАТРУЛЬ',wave:'НАЧАТЬ ВОЛНУ',next:'СЛЕД. ВОЛНА',pause:'ПАУЗА',resume:'ПРОДОЛЖИТЬ',reset:'СБРОС',selected:'Выбрано',defenders:'Защитники',enemies:'Враги',hq:'Штаб',ready:'Выбери защитников, расставь их и запусти волну.',active:'Рейдеры атакуют поселение.',victory:'Волна отбита. Перегруппируй отряд или запускай следующую.',defeat:'Штаб потерян. Сбрось демо и попробуй другую оборону.',defenders_down:'Активных защитников нет. Враги двигаются к штабу.',moveHint:'Тапни по свободной клетке, чтобы переместить выбранный отряд.',patrolHint:'Тапни по клетке, чтобы задать маршрут патруля.',auto:'Защитники автоматически стреляют по врагам в радиусе.',retreated:'отступил',down:'выведен из боя'},
  uk:{title:'RTS БОЙОВЕ ДЕМО',back:'НАЗАД',selectAll:'ОБРАТИ ВСІХ',clear:'СКИНУТИ',move:'РУХ',hold:'ТРИМАТИ',patrol:'ПАТРУЛЬ',wave:'ПОЧАТИ ХВИЛЮ',next:'НАСТ. ХВИЛЯ',pause:'ПАУЗА',resume:'ПРОДОВЖИТИ',reset:'СКИНУТИ',selected:'Обрано',defenders:'Захисники',enemies:'Вороги',hq:'Штаб',ready:'Оберіть захисників, розставте їх і запустіть хвилю.',active:'Рейдери атакують поселення.',victory:'Хвилю відбито. Перегрупуйте загін або запускайте наступну.',defeat:'Штаб втрачено. Скиньте демо та спробуйте іншу оборону.',defenders_down:'Активних захисників немає. Вороги рухаються до штабу.',moveHint:'Торкніться вільної клітинки, щоб перемістити обраний загін.',patrolHint:'Торкніться клітинки, щоб задати маршрут патруля.',auto:'Захисники автоматично стріляють по ворогах у радіусі.',retreated:'відступив',down:'поза боєм'},
  pl:{title:'DEMO WALKI RTS',back:'WRÓĆ',selectAll:'ZAZNACZ WSZYSTKICH',clear:'WYCZYŚĆ',move:'RUCH',hold:'TRZYMAJ',patrol:'PATROL',wave:'URUCHOM FALĘ',next:'NASTĘPNA FALA',pause:'PAUZA',resume:'WZNÓW',reset:'RESET',selected:'Wybrano',defenders:'Obrońcy',enemies:'Wrogowie',hq:'HQ',ready:'Wybierz obrońców, ustaw ich i uruchom falę.',active:'Najeźdźcy atakują osadę.',victory:'Fala odparta. Przegrupuj oddział lub uruchom następną.',defeat:'HQ utracone. Zresetuj demo i spróbuj innej obrony.',defenders_down:'Brak aktywnych obrońców. Wrogowie idą na HQ.',moveHint:'Dotknij wolnego pola, aby przesunąć zaznaczony oddział.',patrolHint:'Dotknij pola, aby ustawić trasę patrolu.',auto:'Obrońcy automatycznie strzelają do wrogów w zasięgu.',retreated:'wycofany',down:'poza walką'},
};
...
export default function RtsDemoGame({ onExit }) {
  ...
  const message = mode === 'move' ? text.moveHint : mode === 'patrol' ? text.patrolHint :
