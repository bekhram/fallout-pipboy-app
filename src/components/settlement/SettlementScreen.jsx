...
export default function SettlementScreen({ settlement, onUpdate, onBack, onCommand, canEdit=true, sharedControls, payment, canClaimProfit=false, onRemoveGuestNpc, ownerCharacter=null, setOwnerCharacter=null }) {
  ...
  const tradeText=({en:{title:'MARKET',closed:'Assign a worker to a trading building to open the market.',tier:'Market tier',buy:'BUY',sell:'SELL',buyPrice:'Buy',sellPrice:'Sell',level:'Level',next:'Next level',upgrade:'UPGRADE',upgradeCost:'Upgrade cost',upgradeTime:'Upgrade time',changes:'Improves',caps:'caps'},ru:{title:'РЫНОК',closed:'Назначьте работника в торговое здание, чтобы открыть рынок.',tier:'Уровень рынка',buy:'КУПИТЬ',sell:'ПРОДАТЬ',buyPrice:'Покупка',sellPrice:'Продажа',level:'Уровень',next:'Следующий уровень',upgrade:'УЛУЧШИТЬ',upgradeCost:'Стоимость улучшения',upgradeTime:'Время улучшения',changes:'Улучшает',caps:'крышек'},uk:{title:'РИНОК',closed:'Призначте працівника до торгової будівлі, щоб відкрити ринок.',tier:'Рівень ринку',buy:'КУПИТИ',sell:'ПРОДАТИ',buyPrice:'Купівля',sellPrice:'Продаж',level:'Рівень',next:'Наступний рівень',upgrade:'ПОКРАЩИТИ',upgradeCost:'Вартість покращення',upgradeTime:'Час покращення',changes:'Покращує',caps:'кришок'},pl:{title:'RYNEK',closed:'Przydziel pracownika do budynku handlowego, aby otworzyć rynek.',tier:'Poziom rynku',buy:'KUP',sell:'SPRZEDAJ',buyPrice:'Kupno',sellPrice:'Sprzedaż',level:'Poziom',next:'Następny poziom',upgrade:'ULEPSZ',upgradeCost:'Koszt ulepszenia',upgradeTime:'Czas ulepszenia',changes:'Ulepsza',caps:'kapsli'}})[language] || {title:'MARKET',closed:'Assign a worker to a trading building to open the market.',tier:'Market tier',buy:'BUY',sell:'SELL',buyPrice:'Buy',sellPrice:'Sell',level:'Level',next:'Next level',upgrade:'UPGRADE',upgradeCost:'Upgrade cost',upgradeTime:'Upgrade time',changes:'Improves',caps:'caps'};
  ...
  const market=useMemo(()=>getSettlementMarket(settlement),[settlement]);
