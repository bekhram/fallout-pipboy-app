...
import { SETTLEMENT_DAY_MS, SETTLEMENT_INCOME_CAPS_PER_POINT, canAffordRoom, canAffordRulebookBuilding, createConstructionBuilding, createRoomConstruction, getConstructionProgress, getRoomConstructionProgress, getSettlementRulebookSnapshot, getStructureRoomCapacity, normalizeStockpile, payRoomCost, payRulebookBuildingCost } from "../../utils/settlementDayEngine.js";
...
function selectedBuildingProduction(settlement,building,language){
  ...
  const copy={
    en:{day:'/day',income:'caps',common:'Common',uncommon:'Uncommon',damage:'damage',effects:'Effects',needs:'needs worker'},
    ru:{day:'/день',income:'крышек',common:'обычные',uncommon:'необычные',damage:'урон',effects:'эффекты',needs:'нужен работник'},
    uk:{day:'/день',income:'кришок',common:'звичайні',uncommon:'незвичайні',damage:'шкода',effects:'ефекти',needs:'потрібен працівник'},
    pl:{day:'/dzień',income:'kapsli',common:'pospolite',uncommon:'niepospolite',damage:'obrażenia',effects:'Efekty',needs:'potrzebny pracownik'},
  };
  ...
  if(site.action==='business'){
    ...
    return '+'+((Number(site.income||0)+skill+perk)*SETTLEMENT_INCOME_CAPS_PER_POINT)+' '+t.income+' '+t.day;
  }
