...
export default function SessionLobby({ language, copy, onNavigate, onBack, onHost, onRestore, onJoin, joinCode, onCode, playerName, onName, busy, error, errorTarget, shareCode, onShare, onCopy, linkCopied }) {
