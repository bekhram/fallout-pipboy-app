...
export default function SessionTacticalMapV3({session,openRequest=0}){
  ...
  const isProceduralOverlay=showWastelandAssets||showSettlementAssets||showRedRocketAssets;
