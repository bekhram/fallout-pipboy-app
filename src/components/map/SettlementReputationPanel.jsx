...
export default function SettlementReputationPanel({ language="en", readOnly=false, locations=[] }) {
  ...
  return <section className="pip-panel settlement-reputation settlement-reputation--standalone">
    ...
    {!readOnly?<div className="settlement-reputation__add-grid">
      ...
      <div className="settlement-reputation__add-card">
        ...
        <button type="button" className="pip-btn is-primary" disabled={!customName.trim()} onClick={addCustom}>{text.add}</button>
      </div>
    </div>:null}
