...
import RtsDemoLauncher from '../settlement/RtsDemoLauncher.jsx';
...
export default function MapScreen(props) {
  ...
  if (demoOpen) return <RtsDemoLauncher onExit={() => setDemoOpen(false)} />;
  return <div className="pip-map-with-settlement-menu">
    <div className="pip-map-settlement-toolbar">
      ...
      <div className="pip-map-settlement-toolbar__actions">
        <button type="button" className="pip-action-button pip-map-settlement-toolbar__button pip-map-settlement-toolbar__demo" onClick={() => { setSharedOpen(false); setDemoOpen(true); }}>
          {text.demo}
        </button>
