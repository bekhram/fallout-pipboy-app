...
const COPY = {
  en: {
    ...
    balance: "ENCOUNTER", party: "Party", enemies: "Enemies", targetXp: "Target XP", actualXp: "Enemy XP", perPlayer: "XP / player", difficulty: "Difficulty", group: "Group",
  ...
  ru: {
    ...
    balance: "ЭНКАУНТЕР", party: "Группа", enemies: "Врагов", targetXp: "Целевой XP", actualXp: "XP врагов", perPlayer: "XP / игрока", difficulty: "Сложность", group: "Группа врагов",
  ...
  uk: {
    ...
    balance: "ЕНКАУНТЕР", party: "Група", enemies: "Ворогів", targetXp: "Цільовий XP", actualXp: "XP ворогів", perPlayer: "XP / гравця", difficulty: "Складність", group: "Група ворогів",
  ...
  pl: {
    ...
    balance: "SPOTKANIE", party: "Drużyna", enemies: "Wrogowie", targetXp: "Docelowe XP", actualXp: "XP wrogów", perPlayer: "XP / gracza", difficulty: "Trudność", group: "Grupa wrogów",
...
export default function GmProceduralRoomDescriptionsV3({ session }) {
