...
export default function GmProceduralRoomDescriptionsV2({ session }) {
  ...
  const specKey = spec ? [spec.type, spec.seed, spec.cols, spec.rows, spec.density, spec.lootRarity, spec.wealth, spec.avgPartyLevel, spec.partySize, spec.encounterDifficulty].join("|") : "";
