...
const TABS = ["world", "battle", "winter", "autogm", "loot", "merchants", "custom", "scene", "tokens", "roster", "participants"];
...
export default function GmSessionMap(props) {
  ...
  return (
    <section className={`gm-tactical-tabs-shell gm-organic-workspace gm-organic-group--${group}`}>
      ...
      {activeTab === "winter" && <GmWinterRulesPanel character={props.character} setCharacter={props.setCharacter} language={i18n.resolvedLanguage || i18n.language} />}
      <div hidden={activeTab === "world" || activeTab === "winter"} className={`gm-tactical-shell gm-tactical-view--${activeTab}`}>
