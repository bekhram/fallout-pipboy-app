...
const COPY = {
  ...
  uk: { battle: "Мапа", screens: "Екрани", survival: "Виживання", winter: "Зима", creatures: "Істоти", supplies: "Постачання", scenes:"Сцени", scene: "Оточення та зустрічі", autogm: "Авто ГМ", reference: "Підказки ГМу", tokens: "Бестіарій", custom: "Мої NPC", roster: "На мапі", participants: "Гравці", loot: "Здобич", merchants: "Торговці", journal: "Журнал", chat: "Чат", dice: "Кубики", more: "Ще", menu: "Робоче місце ГМ", close: "Закрити", effects: "Активні ефекти", subtitle: "Усе для поточної сесії" },
  pl: { battle: "Mapa", screens: "Ekrany", survival: "Przetrwanie", winter: "Zima", creatures: "Istoty", supplies: "Zaopatrzenie", scenes:"Sceny", scene: "Otoczenie i spotkania", autogm: "Auto MG", reference: "Ściąga MG", tokens: "Bestiariusz", custom: "Moi NPC", roster: "Na mapie", participants: "Gracze", loot: "Łup", merchants: "Handlarze", journal: "Dziennik", chat: "Czat", dice: "Kości", more: "Więcej", menu: "Panel MG", close: "Zamknij", effects: "Aktywne efekty", subtitle: "Wszystko dla bieżącej sesji" },
};
