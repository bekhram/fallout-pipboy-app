...
export const WORKSPACE_GROUPS = {
  battle: ["battle", "world"],
  screens: ["scene", "autogm", "reference"],
...
const COPY = {
  en: { battle: "Map", screens: "Screens", survival: "Survival", winter: "Winter", creatures: "Creatures", supplies: "Supplies", scene: "Environment & encounters", autogm: "Auto GM", reference: "GM Reference", tokens: "Bestiary", custom: "My NPCs", roster: "On map", participants: "Players", loot: "Loot", merchants: "Merchants", journal: "Journal", chat: "Chat", dice: "Dice", more: "More", menu: "GM workspace", close: "Close", effects: "Active effects", subtitle: "Your session, at a glance" },
  ru: { battle: "Карта", screens: "Экраны", survival: "Выживание", winter: "Зима", creatures: "Существа", supplies: "Снабжение", scene: "Окружение и встречи", autogm: "Авто ГМ", reference: "Подсказки ГМу", tokens: "Бестиарий", custom: "Мои NPC", roster: "На карте", participants: "Игроки", loot: "Лут", merchants: "Торговцы", journal: "Журнал", chat: "Чат", dice: "Кубики", more: "Ещё", menu: "Рабочее место ГМ", close: "Закрыть", effects: "Активные эффекты", subtitle: "Всё для текущей сессии" },
  uk: { battle: "Мапа", screens: "Екрани", survival: "Виживання", winter: "Зима", creatures: "Істоти", supplies: "Постачання", scene: "Оточення та зустрічі", autogm: "Авто ГМ", reference: "Підказки ГМу", tokens: "Бестіарій", custom: "Мої NPC", roster: "На мапі", participants: "Гравці", loot: "Здобич", merchants: "Торговці", journal: "Журнал", chat: "Чат", dice: "Кубики", more: "Ще", menu: "Робоче місце ГМ", close: "Закрити", effects: "Активні ефекти", subtitle: "Усе для поточної сесії" },
  pl: { battle: "Mapa", screens: "Ekrany", survival: "Przetrwanie", winter: "Zima", creatures: "Istoty", supplies: "Zaopatrzenie", scene: "Otoczenie i spotkania", autogm: "Auto MG", reference: "Ściąga MG", tokens: "Bestiariusz", custom: "Moi NPC", roster: "Na mapie", participants: "Gracze", loot: "Łup", merchants: "Handlarze", journal: "Dziennik", chat: "Czat", dice: "Kości", more: "Więcej", menu: "Panel MG", close: "Zamknij", effects: "Aktywne efekty", subtitle: "Wszystko dla bieżącej sesji" },
};
