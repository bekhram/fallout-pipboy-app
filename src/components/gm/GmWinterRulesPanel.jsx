...
export default function GmWinterRulesPanel({character=null,setCharacter=null,language="en"}){
  ...
  const save=(next)=>writeState({travel,cold,camp,rep,encounterRoll,visitorRoll,visitorSecond,scavengeRollA,scavengeRollB,...next});
