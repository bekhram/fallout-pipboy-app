...
export const MAP_TYPES = V7.MAP_TYPES;
export const makeProceduralSeed = V7.makeProceduralSeed;
export const proceduralLocationType = V7.proceduralLocationType;

export function normalizeProceduralMapSpec(value = {}) {
  const rarity = normalizeRarity(value.lootRarity);
  const base = V7.normalizeProceduralMapSpec(legacyInput(value));
  return {
    ...base,
    lootRarity: rarity,
...
export function generateProceduralMapSvg(input = {}) {
  return V7.generateProceduralMapSvg(legacyInput(input));
}
