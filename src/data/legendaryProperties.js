...
export const LEGENDARY_ARMOR_PROPERTIES = [
  ...
  armor("Cavalier's", ["Arm"], "Defend or Sprint grants temporary Physical DR to all locations until the next turn."),
  armor("Chameleon", ["Torso"], "While hidden and stationary, enemies have increased difficulty finding the wearer."),
  armor("Champion", ["Arm"], "Once per scene, one die on a STR or END test can be set to count as a 1 before rolling."),
  armor("Cloaking", ["Head", "Arm", "Torso", "Leg"], "Once per scene, being hit by a melee attack can turn the wearer invisible."),
  armor("Cryogenic", ["Head", "Arm", "Torso", "Leg"], "Enemy melee attacks have a wider complication range; a complication causes Freeze Energy damage."),
  armor("Cunning", ["Head", "Leg"], "Once per scene, one die on an AGI or PER test can be set to count as a 1 before rolling."),
  armor("Duelist's", ["Arm"], "Enemy melee attacks have a wider complication range; a complication can knock the attacker's weapon away."),
  ...
  armor("Incendiary", ["Head", "Arm", "Torso", "Leg"], "Enemy melee attacks have a wider complication range; a complication causes Persistent Energy damage."),
  ...
  armor("Poisoner's", ["Head", "Arm", "Torso", "Leg"]),
  armor("Powered", ["Head", "Arm", "Leg"]),
  armor("Punishing", ["Torso", "Leg"]),
  armor("Rad Powered", ["Head", "Arm", "Torso", "Leg"]),
  armor("Safecracker's", ["Arm"]),
  armor("Sentinel's", ["Arm"]),
  armor("Sharp", ["Head", "Arm", "Torso", "Leg"]),
  armor("Sprinter's", ["Head", "Leg"]),
  armor("Troubleshooter's", ["Head", "Arm", "Torso", "Leg"]),
  armor("Unyielding", ["Torso"]),
];
