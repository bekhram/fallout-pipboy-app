export const RULEBOOK_BUILDINGS = {
  small_house: { materials: { common: 40 }, constructionDays: 4, effects: { rooms: 1 }, skill: { name: "Repair", rank: 1 }, rarity: "common" },
  large_house: { materials: { common: 60 }, constructionDays: 8, effects: { rooms: 3 }, skill: { name: "Repair", rank: 3 }, rarity: "common" },
  barracks: { materials: { common: 50 }, constructionDays: 6, effects: { rooms: 2 }, skill: { name: "Repair", rank: 2 }, rarity: "common" },
