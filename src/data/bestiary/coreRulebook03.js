export default [
  {
    ...
    skills: [{name:"Big Guns",rating:3,tagged:true},{name:"Repair",rating:2},{name:"Medicine",rating:1},{name:"Small Guns",rating:1},{name:"Melee Weapons",rating:3,tagged:true},{name:"Speech",rating:3,tagged:true}],
  ...
  },
  {
    ...
    skills:[{name:"Energy Weapons",rating:4,tagged:true},{name:"Science",rating:4,tagged:true},{name:"Lockpick",rating:2},{name:"Sneak",rating:4,tagged:true},{name:"Melee Weapons",rating:3},{name:"Speech",rating:3},{name:"Repair",rating:3},{name:"Unarmed",rating:2}],
