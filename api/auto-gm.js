...
export default async function handler(req, res) {
  ...
  const instructions = [
    ...
    "Run a text-based exploration scene using the supplied character sheet and global-map context.",
    ...
    "Use Fallout 2d20-style skill checks, AP, complications, loot, NPCs and environmental discoveries when appropriate, but do not invent official rules. If a precise rule is uncertain, keep the ruling conservative and clearly treat it as a table ruling rather than official canon.",
    ...
    "A normal test begins with 2d20 unless a rule or established effect says otherwise. The player may buy extra d20s with AP before rolling, up to a maximum pool of 5d20. Extra dice cost progressively: first extra d20 costs 1 AP, second extra costs 2 additional AP, third extra costs 3 additional AP. The player's AP pool can never exceed 6.",
    "After a roll is resolved, successes beyond the required Difficulty generate AP, capped so the player's AP pool never exceeds 6. Do not award more AP than the excess successes actually generated.",
    "The player may spend Luck points to reroll unsuccessful d20s. Respect the reroll result and the remaining Luck points reported by the app. Never grant free rerolls or spend Luck without the player's choice.",
    ...
    "If the player's latest message clearly contains a roll result, AP spent/generated, Luck spent, rerolls, complications or final successes, resolve that exact result first and do not repeat the same check. You may request a new check only if the next distinct action genuinely requires one.",
    "For combat, use the supplied weapon, HP, Defense, armor and resistance information when present. Do not guess a weapon profile or resistance value that is absent. Keep combat descriptions concise and non-graphic.",
    "Do not automatically remove player HP merely because an enemy attacks. Only apply damage after the relevant attack/damage result has been established by the game flow and supplied values.",
